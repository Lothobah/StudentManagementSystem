...
from Student_Management_System import StaffViews,StudentViews
from Student_Management_System import EditResultViewClass
from Student_Management_System.EditResultViewClass import EditResultViewClass
...
urlpatterns = [
    ...
    path('edit_admin_profile_save',HodViews.edit_admin_profile_save, name="edit_admin_profile_save"),
# staff url path
    ...
    path('edit_staff_profile_save',StaffViews.edit_staff_profile_save, name="edit_staff_profile_save"),
    path('staff_add_result',StaffViews.staff_add_result, name="staff_add_result"),
    path('save_student_result',StaffViews.save_student_result, name="save_student_result"),
    path('edit_student_result',EditResultViewClass.as_view(), name="edit_student_result"),
    path('fetch_student_results',StaffViews.fetch_student_results, name="fetch_student_results"),
# student url path
    ...
    path('edit_student_profile_save',StudentViews.edit_student_profile_save, name="edit_student_profile_save"),
    path('student_view_results',StudentViews.student_view_results, name="student_view_results"),
    #adding two numbers
    path('add_two_numbers',StaffViews.add_two_numbers, name="add_two_numbers"),
