...
from Student_Management_System.models import SessionYearModel,Subjects,StudentResults
...
class EditResultForm(forms.Form):
    ...
    student_id=ChoiceValidation(label="Student",widget=forms.Select(attrs={"class":"form-control"}))
    assignment_mark=forms.CharField(label="Assignment Mark",widget=forms.TextInput(attrs={"class":"form-control","autocomplete":"off"}))
    exam_mark=forms.CharField(label="Exam Mark",widget=forms.TextInput(attrs={"class":"form-control","autocomplete":"off"}))
